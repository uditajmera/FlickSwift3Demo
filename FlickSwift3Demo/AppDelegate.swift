...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        // Initialise FlickrManager with your flickr api key and shared secret
        let lstrApiKey: String! = "91dbf8aaad23e6a87077403975b24f2f"
        let lstrSecret: String! = "20c593f82d8443e8"
        
        if (lstrApiKey == nil || lstrSecret == nil)
        {
        ...
        {
            FlickrManager.sharedInstance.initialize(withAPIKey: lstrApiKey,
                                                    lstrSecret: lstrSecret)
        }
